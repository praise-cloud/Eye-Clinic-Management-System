    ...
    <div className="space-y-10 max-w-7xl">
      ...
      <div className="dashboard-grid h-auto">
        <div className="card-premium p-6 flex items-center gap-5">
          ...
          <div>
            <p className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Total Patients</p>
      ...
      <div className="card-premium overflow-hidden">
        <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h2 className="text-xl font-black text-slate-900 dark:text-white tracking-tight">Today's Patient Roster</h2>
        ...
        {(patientsLoading || testsLoading) ? (
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left">
              <thead className="bg-slate-50/50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
                <tr>
                  <th className="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Patient Name</th>
          ...
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <p className="text-slate-400 font-bold tracking-tight">No registered patients found</p>
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 animate-premium-fade" onClick={() => setDeleteConfirm(null)}>
          <div className="card-premium p-8 max-w-md w-full mx-4 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Erase Patient Record?</h3>
