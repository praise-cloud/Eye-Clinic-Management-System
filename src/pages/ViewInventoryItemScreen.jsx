        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Unit Code: {item.item_code}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Unit of Issue</p>
