...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getSqlServerConfig: () => ipcRenderer.invoke('system:getSqlServerConfig'),
    setSqlServerConfig: (config) => ipcRenderer.invoke('system:setSqlServerConfig', config),
    testSqlServerConnection: (config) => ipcRenderer.invoke('system:testSqlServerConnection', config),
    runSqlServerSync: () => ipcRenderer.invoke('system:runSqlServerSync'),
